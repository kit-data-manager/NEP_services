...
//Allow to access subproperties by splitting "."
    ...
    jsonform.util.getObjKey = function (obj, key, ignoreArrays) {
        ...
        for (var i = 0; i < keyparts.length; i++) {
            ...
            if (arrayMatch) {
                while (true) {
                    if (prop && !_.isArray(innerobj[prop]))
                        return null;
    ...
    formTree.prototype.initialize = function (formDesc) {
        ...
        // create file TODO
        //this.root.appendChild(jsonform.elementTypes['file']);
    };
    ...
    formTree.prototype.validate = function (noErrorDisplay) {
        ...
        if (options.validate !== false) {
            ...
            try {
                ...
                $(this.domRoot).jsonFormErrors(schemaIsNotValid, false, options);
                if (!valid) {
                    if (!errors) {
                        errors = [];
                    }
            ...
            if (errors && !noErrorDisplay) {
                if (options.displayErrors) {
                    ...
                    $(this.domRoot).jsonFormErrors(schemaIsNotValid, errors, options);
                }
            }
        }
     ...
     */
    $.fn.jsonFormErrors = function (schemaIsNotValid, errors, options) {

        $(".error", this).removeClass("error");
        $(".warning", this).removeClass("warning");

        $(".jsonform-errortext", this).hide();
        $(".jsonform-schema-errortext", this).hide();

        // No Errors from Validator
        if (!errors)
            return;
        ...
        if (schemaIsNotValid) {
            ...
            $("#alert-modal .modal-body>p").append(errors[0]);
        ...
        for (var i = 0; i < errors.length; i++) {
            ...
            $(errormarkerclass + " .jsonform-errortext", this).html(message).show();
        }
