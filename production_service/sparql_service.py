...
class SPARQLService:
    ...
    def execute_query(self, query, arg1, arg2):
        """
        ...
        response_dict={'results': {'bindings': []}}
        for row in self.endpoint.query(query):
            response_dict['results']['bindings'].append({arg1: {'value': row[0]}, arg2: {'value': row[1]}})
